(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":750,"designHeight":1334,"scaleMode":"fixedauto","alignH":"center","screenMode":"vertical","backgroundColor":"rgba(0, 0, 0, 0)","alignV":"top"},"2D":{"FPS":30,"useRetinalCanvas":true,"defaultFont":"","isAntialias":true,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFontSize":20},"splash":{"image":"","fit":"center","duration":2,"enabledInPreview":true,"enabled":true},"3D":{"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":16,"lightClusterCount":{"x":12,"y":12,"z":12},"maxMorphTargetCount":32,"useBVHCull":false,"BVH_max_SpatialCount":7,"BVH_limit_size":32,"BVH_Min_Build_nums":10},"physics2D":{"allowSleeping":true,"gravity":{"x":0,"y":9.8},"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false},"physics3D":{"maxSubSteps":1,"fixedTimeStep":0.016666666666666666,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"startupScene":"Loading.ls","pkgs":[{"path":"","hash":"ace0c"}]}`);
