(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":750,"designHeight":1334,"scaleMode":"fixedauto","alignH":"center","screenMode":"vertical","backgroundColor":"rgba(0, 0, 0, 0)","alignV":"top"},"2D":{"FPS":30,"useRetinalCanvas":true,"defaultFont":"","isAntialias":true,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFontSize":20},"splash":{"image":"","fit":"center","duration":2,"enabledInPreview":true,"enabled":true},"3D":{"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"lightClusterCount":{"x":12,"y":12,"z":12},"maxMorphTargetCount":32},"physics2D":{"allowSleeping":true,"gravity":{"x":0,"y":9.8},"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false,"layers":["Default"]},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001,"layers":["Default"]},"addons":{},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"dcc":{"enable":false,"generate":false,"version":"1.0.0","desc":"update resources","reserveOld":true},"startupScene":"Loading.ls","pkgs":[{"path":"","autoLoad":true,"hash":"d6465"}]}`);
